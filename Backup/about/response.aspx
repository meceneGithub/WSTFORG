                	...
                	<div class="container_24">
                    	<div class="wrapper">
                            ...
                            <h3>Retreat Info:</h3>
                              <ul class="ul-1">
                                    <li><a href="/about/retreatinfo.html">Retreat Details</a></li>
                                    <li><a href="directions.html">Directions to Indian Lake Resorts</a></li>
                                    <li><a href="../registration/register.aspx">Registration</a></li>                          
                                </ul>               
                            </article>
                            <article class="grid_16">
                                <div class="indent-bottom">
                               <div class="section" style=" font-size:large">
                                    <h3 runat="server" id="sThanks">
                                        Thank You.</h3><br /><br />
                                    <div style="font-size: large">
                                        <asp:Label ID="responseText" runat="server" Text=""></asp:Label></div>
            </div>
                </div>
