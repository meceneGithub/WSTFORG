<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="success.aspx.cs" Inherits="WSTFORG.registration.success" %>
                ...
                <div class="container_24">
	                <div class="wrapper" style=" border:solid 1px #8d8d8d; width:550px; padding:10px; margin:0 auto;">
    	                <article class="grid_17 suffix_7">
                             <p class="contentText">
                                <div style="font-size: medium">Thank you for your payment. Your transaction has been completed, and a receipt for your purchase has been emailed to you. <a href='/about/retreatinfo.html'>Click here</a> to learn more about the retreat.";</div>
                            </div>
                   </div>
