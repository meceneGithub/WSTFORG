<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="response.aspx.cs" Inherits="WSTFORG.about.response" %>
                ...
                <div class="main">
                	<div class="container_24">
                    	<div class="wrapper">
                            ...
                            <h3 style="font-size:22px">Retreat Info:</h3>
                              <ul class="ul-1">
                                    <li><a href="retreatinfo.html">Retreat Details</a></li>
                                    <li><a href="directions.html">Direction</a></li>
                                    <li><a href="../slides/slides.html">View Pictures</a></li> 
                                   <li><a href="../videos/videos.html">View Pictures</a></li>                           
                                </ul>               
                            </article>
                            <article class="grid_16">
                                <div class="indent-bottom">
                                   <p class="section" style=" font-size:large">
                                        <h3 runat="server" id="sThanks" style="font-size:22px">Thank You!</h3>
                                       <p class="contentText" style="line-height: 22px">
                                            <asp:Label ID="responseText" runat="server" Text=""></asp:Label></p>
                                   </div>

                                     <div>
                                <p class="contentText" style="line-height: 22px">
                                    <a href="/about/retreatinfo.html" style="text-decoration: underline; color: Blue">Click here</a> and learn more about the 2016 Haitian women conference
                                </p>
                            </div>
